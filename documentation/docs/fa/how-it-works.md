# چت‌گارد: رمزنگاری سرتاسری ساده

## معرفی

چت‌گارد یک لایه حریم خصوصی است که پیام‌ها را روی دستگاه شما رمزنگاری کرده و آن‌ها را به متنی شبیه شعر فارسی تبدیل می‌کند تا بتوانید از طریق پیام‌رسان‌های موجود مانند ایتا، بله، سروش، تلگرام و سایر برنامه‌های مشابه ارسال کنید. تمامی کلیدهای رمزنگاری فقط روی دستگاه شما نگهداری می‌شوند و چت‌گارد هیچ سرور یا حساب کاربری‌ای ندارد.

طراحی چت‌گارد بر **پیام‌های کوتاه** و **سادگی پیاده‌سازی** متمرکز است و قابلیت‌هایی مانند Perfect Forward Secrecy یا Double Ratchet که در پیام‌رسان‌هایی مانند Signal استفاده می‌شوند را ارائه نمی‌دهد.
