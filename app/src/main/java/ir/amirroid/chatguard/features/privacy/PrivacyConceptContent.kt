...
internal object PrivacyConceptContent {
    ...
    val TIMELINE_STEPS = listOf(
        ...
        PrivacyTimelineStep(
            ...
            description = "قبل از گفت‌وگوی محرمانه، شما و طرف مقابل یک بار کلید عمومی یکدیگر را در همان چت دریافت می‌کنید."
        ),
        PrivacyTimelineStep(
            stepLabel = "۳",
    ...
    const val KEY_EXCHANGE_BODY =
        "مثل دادن یک قفل اختصاصی: هر دو طرف باید بدانند «قفل این گفت‌وگو» با کدام کلید باز می‌شود. " +
            ...
            "پس بهتر است از درست بودن کلید اطمینان حاصل کنید."
